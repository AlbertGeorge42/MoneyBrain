...
export function useIncomeExpense(startDate: string, endDate: string, includePredictions?: boolean) {
  return useQuery({
...
export function useCashFlow(startDate: string, endDate: string, includePredictions?: boolean) {
  return useQuery({
...
export function useInvestmentAnalysis(startDate: string, endDate: string) {
  return useQuery({
