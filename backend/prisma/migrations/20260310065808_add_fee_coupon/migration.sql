...
CREATE TABLE "new_transactions" (
    ...
    "coupon" DECIMAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_transactions" ("accountId", "amount", "categoryId", "createdAt", "date", "id", "isAdjustment", "note", "relatedTransactionId", "toAccountId", "type") SELECT "accountId", "amount", "categoryId", "createdAt", "date", "id", "isAdjustment", "note", "relatedTransactionId", "toAccountId", "type" FROM "transactions";
